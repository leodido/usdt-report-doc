# -*- encoding: utf-8 -*-
# stub: ffi-aspell 1.1.0 ruby lib

Gem::Specification.new do |s|
  s.name = "ffi-aspell".freeze
  s.version = "1.1.0"
  ...
  s.date = "2015-05-15"
  s.description = "FFI bindings for Aspell".freeze
  s.email = "yorickpeterse@gmail.com".freeze
  s.homepage = "https://github.com/yorickpeterse/ffi-aspell".freeze
  s.licenses = ["MPL-2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new(">= 1.9.3".freeze)
  s.rubygems_version = "2.7.6.2".freeze
  s.summary = "FFI bindings for Aspell".freeze
